...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("SKN");
    case mBTC: return QString("mSKN");
    case uBTC: return QString::fromUtf8("μSKN");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("SKOINs"));
    case mBTC: return QString(QObject::tr("Milli-SKOINs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-SKOINs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
